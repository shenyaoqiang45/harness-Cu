...
4. **截至 2026-08-03**：本轮核 White House；未见精炼铜分阶段关税新 Proclamation（铜相关仍止于 2026-06-01 衍生品/完税价调整）。维持 `confidence B`。
...
| 状态 | 优先级 | 日期 | 事件 | 影响模块 | 触发动作 |
|:---:|---|---|---|---|---|
| [ ] | P1 | **08-03** | 美国 ISM 制造业 PMI（7 月） | 全球制造业 | **已核、待发布**：ISM 日历 8 月场次为 **08-03 10:00 ET**（≈22:00 BJT），非 8/1；发布后录 `us_ism_manufacturing`；`cli run` |
...
| [ ] | P1 | **08-03** | 全球制造业 PMI（7 月终值，S&P Global / JPMorgan） | 全球制造业 | **已核、待发布**：S&P 日历 **08-03 15:00 UTC**（≈23:00 BJT）；首页仍示 Jun 52.2；**暂不录入**（clean 中 derived 49.2 为代理，勿当官方） |
